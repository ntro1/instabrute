#!/bin/bash
# Coded by: github.com/jalladsathwara
# Instagram: @r1dh4m_547hw4r4
...
printf "\n"
printf "\e[1;77m\e[45m  Instagram Brute Forcer  Author: jalladsathwara (Github)(IG: @r1dh4m_547hw4r4)   \e[0m\n"
printf "\n"
}
...
let token++
https://github.com/avramit/Instahack/issues/76printf "\e[1;77mTrying pass (%s/%s)\e[0m: %s\n" $countpass $count_pass $pass #token
